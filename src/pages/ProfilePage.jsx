...
import { UserCircle, Mail, Briefcase, Shield, Phone, Camera, CheckSquare, BookmarkCheck, CalendarCheck, ClipboardList, ListTodo, Eye, EyeOff } from "lucide-react";
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-600 focus:bg-white outline-none transition-all text-gray-900 pr-10"
                  />
                  <button
                    type="button"
