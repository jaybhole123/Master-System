      ...
      <div className="max-w-5xl mx-auto space-y-6 p-2 sm:p-4">
        ...
        <div className="flex flex-col gap-2 mb-2">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-red-100 rounded-xl text-red-700 shadow-sm">
                <Video className="h-6 w-6" />
            </div>
            <div>
                <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-gray-900">
                    Training <span className="text-red-700">Videos</span>
                </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-red-100/50 overflow-hidden border border-red-100">
          <div className="bg-gradient-to-r from-red-50 via-white to-pink-50 p-5 border-b border-red-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-white rounded-2xl shadow-lg shadow-red-100/30 p-6 border border-red-50">
                <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Info className="w-5 h-5 text-red-500" />
                    Quick Tips for Best Experience
                </h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <li className="flex items-start gap-3 p-3 rounded-xl bg-red-50/50 border border-red-100/50 transition-all hover:bg-red-50">
                        <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs font-black flex-shrink-0">1</div>
                    ...
                    <li className="flex items-start gap-3 p-3 rounded-xl bg-red-50/50 border border-red-100/50 transition-all hover:bg-red-50">
                        <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs font-black flex-shrink-0">2</div>
                    ...
                    <li className="flex items-start gap-3 p-3 rounded-xl bg-red-50/50 border border-red-100/50 transition-all hover:bg-red-50">
                        <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs font-black flex-shrink-0">3</div>
                    ...
                    <li className="flex items-start gap-3 p-3 rounded-xl bg-red-50/50 border border-red-100/50 transition-all hover:bg-red-50">
                        <div className="w-6 h-6 rounded-full bg-red-100 text-red-600 flex items-center justify-center text-xs font-black flex-shrink-0">4</div>
            ...
            <div className="bg-gradient-to-br from-red-600 to-indigo-700 rounded-2xl p-6 text-white shadow-xl flex flex-col justify-between">
                <div>
                ...
                <button className="w-full py-3 bg-white text-red-700 font-black rounded-xl hover:bg-red-50 transition-all shadow-lg active:scale-95 uppercase tracking-wider text-xs">
                    Contact Support
                </button>
            </div>
        </div>
